<?php
        ...
        try {
            ...
            $mail->addAddress($trialUserEmail , 'Nom dutilisateur');     //Add a recipient
            ...
            */
            ...
            $mail->Body    = "Bonjour " . $trialUserFirstName . ",<br> <em> !</em><br><em></em><br> <span>Votre date d'expiration pour la période d'essai va prendre fin le " . $expiryDate . ".<br> Si vous n'etes pas d'accord avec cette decision, veuillez bien prendre contact avec ADNR Consults afin de trouver une solution." . "<br>ADNR Groups vous souhaite une excellente Journée.";
