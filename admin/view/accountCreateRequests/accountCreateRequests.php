...
?>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="view/accountCreateRequests/style.css?version=1">
		<link rel="stylesheet" type="text/css" href="lib/css/styleMenubar.css?version=1">
				<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.2.4/jquery.min.js"></script>
		<script src="https://cdnjs.cloudflare.com/ajax/libs/modernizr/2.8.3/modernizr.js"></script>
		<title>Admin - Demande de création</title>
	</head>
	<body id="setFont">
		<!------------ LOADING SCREEN ------------->
		...
		<h2 id="title">DEMANDE DE CREATION DU COMPTE</h2>
		...
		<div id="dashboardMenuOptions">
			...
			?>
						<tr> 
						    ...
						    <td><a href="index.php?action=rejectThisPraticienAccountRequest&id=<?= $rows['id'] ?>">Refuser</a></td>
						</tr> 
		...
		<script type="text/javascript" src="view/accountCreateRequests/main.js"></script>
	</body>
	</html>
