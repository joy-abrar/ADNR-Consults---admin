<?php
        ...
        try {
            ...
            */
            ...
            $mail->Body    = "Bonjour " . $praticienName . ",<br> <em> !</em><br><em></em><br> <span>Après avoir etudie votre dossier, nous ne pouvons pas vous donner une suite favorable de votre demande de creation du compte praticien chez ADNR Consults à ce jour.<br> Si vous contestez cette decision, merci de bien vouloir contacter ADNR Consults pour avoir plus de renseignements." . "<br>ADNR Groups vous souhaite une excellente Journée.";
