<?php
        ...
        try {
            ...
            */
            ...
            $mail->Subject = 'Validation du compte ADNR Consults';
            $mail->Body    = "Bonjour " . $praticienName . ",<br> <em>Félicitations !</em><br><em></em><br> <span>Votre compte praticien d'ADNR Consults a bien été vérifié et validés par nos administrateurs.<br> Vous pouvez desormais vous connecter dessus.<br>Pour rappeler, votre Identifiant est : " . $praticienLogin . "<br>ADNR Groups vous souhaite une excellente Journée.";
